...
function scrollFunction() {
  if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
    document.getElementById("header").style.backgroundColor = "#EAEAEA";
    ...
    document.getElementById("shape").style.width = "1000px";
    document.getElementById("shape").style.height = "2853px";
    document.getElementById("shape").style.left = "190px";
    document.getElementById("shape").style.top = "200px";
